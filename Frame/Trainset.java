...
public class Trainset  extends JFrame implements ActionListener
{
     ImageIcon img;
	...
	Color myColor;
     ...
     public Trainset()
     {
		...
		panel.setLayout(null);
          ...
          r1 = new JRadioButton("AC_B (AC Berth)");
		r1.setBounds(70, 100, 150, 30);
		r1.setBackground(Color.ORANGE); 
          myFont = new Font("Cambria", Font.PLAIN, 24);
		panel.add(r1);
		
		r2 = new JRadioButton("AC_S (AC Seat)");
		r2.setBounds(70, 120, 150, 30);
		r2.setOpaque(false);
          myFont = new Font("Cambria", Font.PLAIN, 24);
		panel.add(r2);
		
		r3 = new JRadioButton("F_BERTH (F Berth)");
		r3.setBounds(70, 140, 150, 30);
          myFont = new Font("Cambria", Font.PLAIN, 24);
		panel.add(r3);

          r4 = new JRadioButton("F_CHAIR (F Chair)");
		r4.setBounds(70, 160, 150, 30);
          myFont = new Font("Cambria", Font.PLAIN, 24);
		panel.add(r4);

          r5 = new JRadioButton("S_CHAIR (Elegant Chair)");
		r5.setBounds(70, 180, 150, 30);
          myFont = new Font("Cambria", Font.PLAIN, 24);
		panel.add(r5);

          r6 = new JRadioButton("SHOVAN");
		...
		beg2.add(r9);
          ...
          p1 = new JLabel("Seat Type :  AC_B (AC Berth)    tk: 2500");
		...
		p1.setFont(myFont);
          ...
          p2 = new JLabel("Seat Type :  AC_S (AC Seat)    tk: 2000");
		...
		panel.add(p2);
          ...
          p3 = new JLabel("Seat Type :  F_BERTH (F Berth)  tk: 1650");
		...
		panel.add(p3);
          ...
          p4 = new JLabel("Seat Type :  F_CHAIR (F Chair)  tk: 1300");
		...
		panel.add(p4);
          ...
          p5 = new JLabel("Seat Type : S_CHAIR (Elegant Chair)   tk: 1000 ");
		...
		panel.add(p5);
          ...
          p6 = new JLabel("Seat Type :   SHOVAN     tk: 600 ");
	...
	public void actionPerformed(ActionEvent ae) 
	{
          if (ae.getSource() == NextBtn) 
		{
		...
		else if (ae.getSource() == BackBtn) 
          {
              ...
              Trainavalable f22=new Trainavalable();
			f22.setVisible(true);
			this.setVisible(false);
          }
      }
