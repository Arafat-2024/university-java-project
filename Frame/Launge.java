...
public class Launge extends JFrame implements ActionListener
{
     ImageIcon img;
	...
	Color myColor;
     ...
     public Launge()
     {
       ...
       //Fromlebel
		...
		//combo box
		String itemss[] = {"Bola", "Jalokati", "Chittagong"};
		...
		panel.add(BackBtn);
          ...
          img = new ImageIcon("Image/images5.png");
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		{
			Laungeavalable l2=new Laungeavalable();
			l2.setVisible(true);
			this.setVisible(false);
		}
	}	
